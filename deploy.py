...
# Add allowed hosts
subprocess.call(
 "ssh {} 'sed -i s/\"ALLOWED_HOSTS = \[\]\"/\"ALLOWED_HOSTS = \[£'petrank.samireland.com£', £'petrank.harston.io£', £'petrank.io£', £'www.petrank.io'£\]\"/g ~/{}/source/core/settings.py'".format(sitename, sitename),
 shell=True
)
subprocess.call(
...
# Change where uploaded files go
subprocess.call(
 "ssh {} 'sed -i s/\"BASE_DIR, \\\"media\\\"\"/\"\\\"..\\\", \\\"media\\\"\"/g ~/{}/source/core/settings.py'".format(sitename, sitename),
 shell=True
)

# Make data go above source
subprocess.call(
 "ssh {} 'sed -i s/db.sqlite3/..\\\/db.sqlite3/g ~/{}/source/core/settings.py'".format(sitename, sitename),
 shell=True
)
...
subprocess.call(
 "ssh {} '~/{}/env/bin/pip install -r ~/{}/source/requirements.txt -r ~/{}/source/requirements.txt'".format(sitename, sitename, sitename, sitename),
 shell=True
)
